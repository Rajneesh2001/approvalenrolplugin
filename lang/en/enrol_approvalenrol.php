...
$string['email'] = 'Email';
$string['enrol_success_message'] = 'Welcome {$a}';
...
$string['autoapprove_help'] = 'If enabled, further Approval Requests for the course are automatically approved.';
$string['autoreject'] = 'Auto Reject';
$string['autoreject_help'] = 'If enabled, further Approval Requests for the course are automatically rejected.';
$string['yes'] = 'Yes';
$string['no'] = 'No';
$string['autoapprove_error'] = 'Auto approve and auto reject settings cannot be the same.';
$string['autoapprovereject_help'] = 'Enable or disable the auto-approve-reject option.';
