...
/**
 * Event triggered when a new approver record is created in the enrol_approvalenrol_approvers table.
 */
class approver_created extends base
{
    ...
    {
        return get_string('approvercreated', 'enrol_approvalenrol');
    }
    ...
    public function get_description()
    {
        ...
        return get_string('approvercreated:desc', 'enrol_approvalenrol', $descriptionobj);
    }

    /**
     * Returns the URL relevant to the approver created event.
     *
     * @return \moodle_url
     */
